let firstName = prompt("Enter your first name", "Dorsa")
let lastName = prompt("Enter your last name", "Valli")
let birthYearShamsi = Number(prompt("Enter your birth year (Shamsi)", "1381"))
