let firstName = prompt("Enter your first name", "Erfan")
let lastName = prompt("Enter your last name", "Abdi")
let birthYearShamsi = Number(prompt("Enter your birth year (Shamsi)", "1378"))
